        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="text-center">
            ...
            <div class="sm mt-5 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 sm:px-0 lg:mt-6">
              <Link to="/studentsignup" class="mt-4 rounded-md border-2 border-violet-700 bg-violet-700 px-8 py-3 font-medium text-lg text-white transition hover:translate-y-1">
                Get Started
              </Link>
