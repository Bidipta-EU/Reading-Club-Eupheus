...
const StudentSignUp = () => {
  return (
    <div>
      <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-px box-border gap-[44px] tracking-[normal] mq725:gap-[22px_44px]">
        <img
          className="w-full h-[450px] absolute !m-[0] top-[88px] right-[0px] left-[0px] max-w-full overflow-hidden shrink-0 object-cover"
          alt=""
          src="/rectangle@2x.png"
        />
        <Header name={"Login"} highlight={"studreg"} />
