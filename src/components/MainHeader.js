          ...
          <div class="mx-auto grid max-w-lg grid-cols-1 gap-y-12 lg:max-w-full lg:grid-cols-2 lg:items-center lg:gap-x-8">
            <div>
              <div class="text-center lg:text-left">
                ...
                <h1 class="max-w-md text-4xl font-bold leading-snug sm:text-5xl sm:leading-snug">
                  <span >The Reading Club </span>
                </h1>
                <p class="mt-2 text-lg text-gray-600 sm:mt-8">
                  Next Batch Starting This Summer
                </p>
                <div class="mt-3 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 lg:justify-start">
                  <Link to="/studentsignup" class="relative mt-4 rounded-lg border-2 border-purple-600 bg-purple-600 px-6 py-2 font-medium text-white transition hover:translate-y-1">
            ...
            <div class="relative bg-violet-100 lg:bg-transparent">
              ...
              <div className="">
                <img
                  className="h-[418px] w-[637.5px] relative object-cover max-w-full z-[3]"
                  loading="lazy"
                  alt=""
                  src="/hero-img.png"
                />
